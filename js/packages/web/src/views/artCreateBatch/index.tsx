...
const attributesDefault = {
  ...
  external_url: 'https://gateway.pinata.cloud/ipfs/QmfYKqaL4ue59aRf2Hki2EQtTFjNW1Lw9UhU8Drw4xhJF5',
  image: '',
...
export const ArtCreateBatchView = () => {
...
export const ArtCreateSingleItem = ({
  ...
  const createFile = async () => {
    ...
    const imageUrl = `/art-collection/${imageIdx}.png`;
